...
///=======================================================
//print subarrays
// void printSubarrays(int arr[], int n) {  //int arr[] == int *arr, int arr[] pts to 1st ele only
...
//     printSubarrays(arr, n); //we pass size always, bcz arr is ptr, its passed by ref
